...
- (id)init
{
	if (self = [super init])
	{
		...
		m_remotingCall.URL = [NSURL URLWithString:@"http://leoburnett.mediaflex.pl/2012_kartka_LEO/amf/index.php/amf/gateway"];
		m_remotingCall.service = @"ccservice";
...
- (void)callAddMethod
{
	m_remotingCall.method = @"saveData";
    ...
    m_remotingCall.arguments = [NSArray arrayWithObjects:@"test name", @"testemail@gmail.com", @"test wishes; wish you good luck", @"test user", nil];
